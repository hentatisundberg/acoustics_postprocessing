...
if __name__ == "__main__":
    ...
    # Scatter with log transform and thresholds (save to file)
    cmd = interpreter.parse_command(
        f"scatter y:{ycol} log=true min=1 save=true show=false out=outputs/plots/smoke_scatter_transform.png"
    )
