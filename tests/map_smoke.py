...
params = {
    "dir": "./data/data",
    "pattern": "SLUAquaSailor2020V3-Phase0-*.csv",
...
# Prefer 'depth' then 'backscatter', otherwise first numeric column
...
res2 = executor.execute({"task": "hex_map", "y": col, "resolution": 8})
print(res2.message)
